...
public class SearchBar extends RelativeLayout implements View.OnClickListener{
    ...
    private void build(){
        setClickable(true);
        placeholderIcon = (ImageView) findViewById(org.althash.wallet.R.id.icon);
        placeholderText = (TextView) findViewById(org.althash.wallet.R.id.text);
        input = (EditText) findViewById(org.althash.wallet.R.id.input);
        placeholder = (LinearLayout) findViewById(org.althash.wallet.R.id.placeholder);
        cancel = (Button) findViewById(org.althash.wallet.R.id.cancel);

        clearSearch = (ImageView) findViewById(org.althash.wallet.R.id.bt_clear_search);
