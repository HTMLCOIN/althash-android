package org.althash.wallet.utils.crypto;
...
public class KeyStoreHelper {
    ...
    public final static String ALTHASH_PIN_ALIAS = "althash_alias";

    public static String getSeed(Context context, @NonNull String pin) {
        String cryptoSaltPassphrase = AlthashSharedPreference.getInstance().getSeed(context);
