package org.althash.wallet.dataprovider.services.update_service;
...
import org.althash.wallet.dataprovider.firebase.FirebaseSharedPreferences;
import org.althash.wallet.dataprovider.firebase.listeners.FireBaseTokenRefreshListener;
...
import org.althash.wallet.datastorage.QStoreStorage;
...
import org.althash.wallet.model.gson.qstore.PurchaseItem;
...
import org.althash.wallet.utils.BoughtContractBuilder;

import org.althash.wallet.R;
import org.althash.wallet.dataprovider.services.update_service.listeners.ContractPurchaseListener;
import org.althash.wallet.dataprovider.services.update_service.listeners.TokenListener;
import org.althash.wallet.dataprovider.services.update_service.listeners.TransactionListener;
...
import org.althash.wallet.utils.CurrentNetParams;
import org.althash.wallet.utils.DateCalculator;
import org.althash.wallet.utils.AlthashIntent;
...
import static org.althash.wallet.WearListCallListenerService.ADDRESS;
import static org.althash.wallet.WearListCallListenerService.BALANCE;
import static org.althash.wallet.WearListCallListenerService.CURR_TIME_MILLS;
import static org.althash.wallet.WearListCallListenerService.ITEMS;
import static org.althash.wallet.WearListCallListenerService.UNC_BALANCE;
import static org.althash.wallet.utils.StringUtils.convertBalanceToString;
...
public class UpdateService extends Service implements GoogleApiClient.ConnectionCallbacks {
    ...
    public void onCreate() {
        ...
        final AlthashSharedPreference althashSharedPreference = AlthashSharedPreference.getInstance();

        String balanceString = althashSharedPreference.getBalanceString(getApplicationContext());
        final String unconfirmedBalanceString = althashSharedPreference.getUnconfirmedBalanceString(getApplicationContext());
        Long lastUpdatedBalanceTime = althashSharedPreference.getLastUpdatedBalanceTime(getApplicationContext());
            ...
            public void call(Object... args) {
                try {
                    ...
                    try {
                        ...
                        althashSharedPreference.setBalanceString(getApplicationContext(), balance.toString());
                        althashSharedPreference.setUnconfirmedBalanceString(getApplicationContext(), unconfirmedBalance.toString());
                        althashSharedPreference.setLastUpdatedBalanceTime(getApplicationContext(), mLastUpdatedBalanceTime);
    ...
    private void onBalanceChange() {
        AlthashService.newInstance().getHistoryListForSeveralAddresses(addresses, 10, 0)
    ...
    private void sendNotification(String Ticker, String Title, String Text, Uri sound) {
        ...
        notificationIntent.setAction(AlthashIntent.OPEN_FROM_NOTIFICATION);
