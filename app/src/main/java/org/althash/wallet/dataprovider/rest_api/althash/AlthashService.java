package org.althash.wallet.dataprovider.rest_api.althash;

import com.google.gson.Gson;
import com.google.gson.GsonBuilder;

import org.althash.wallet.model.gson.BlockChainInfo;
...
import org.althash.wallet.model.gson.qstore.QstoreBuyResponse;
import org.althash.wallet.model.gson.qstore.QstoreByteCodeResponse;
import org.althash.wallet.model.gson.qstore.QstoreContract;
import org.althash.wallet.model.gson.qstore.QstoreItem;
import org.althash.wallet.model.gson.qstore.QstoreSourceCodeResponse;
...
public class AlthashService {

    private static AlthashService sAlthashService;
    private AlthashRestService mServiceApi;

    public static AlthashService newInstance() {
        if (sAlthashService == null) {
            sAlthashService = new AlthashService();
        }
        return sAlthashService;
    }

    private AlthashService() {
        try {
            ...
            mServiceApi = retrofit.create(AlthashRestService.class);
    ...
    public Observable<TokenHistoryResponse> getTokenHistoryList(String hrc20ContractAddress, int limit, int offset, List<String> addresses){
        return mServiceApi.getTokenHistoryList(hrc20ContractAddress, limit, offset, addresses);
    }
