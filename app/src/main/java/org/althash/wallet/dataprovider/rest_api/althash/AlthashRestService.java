...
interface AlthashRestService {
    ...
    @GET("/erc20/{hrc20ContractAddress}/transfers")
    Observable<TokenHistoryResponse> getTokenHistoryList(@Path("hrc20ContractAddress") String hrc20ContractAddress, @Query("limit") int limit, @Query("offset") int offset, @Query("addresses[]") List<String> addresses);
