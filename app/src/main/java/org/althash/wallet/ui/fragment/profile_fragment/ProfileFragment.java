...
import org.althash.wallet.ui.fragment.about_fragment.AboutFragment;
...
import static org.althash.wallet.ui.fragment.pin_fragment.PinAction.AUTHENTICATION_FOR_PASSPHRASE;
import static org.althash.wallet.ui.fragment.pin_fragment.PinAction.CHANGING;
...
public abstract class ProfileFragment extends BaseNavFragment implements ProfileView, OnSettingClickListener {
    ...
    @BindView(org.althash.wallet.R.id.pref_list)
    ...
    public void onSettingClick(int key) {
        ...
        switch (key) {
            ...
            case org.althash.wallet.R.string.log_out:
                ...
                break;
            case org.althash.wallet.R.string.switch_theme:
    ...
    public void onSwitchChange(int key, boolean isChecked) {
        switch (key) {
            case org.althash.wallet.R.string.touch_id:
