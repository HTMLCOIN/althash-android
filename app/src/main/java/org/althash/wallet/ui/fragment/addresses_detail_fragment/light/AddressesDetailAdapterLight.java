...
import org.althash.wallet.ui.fragment.addresses_detail_fragment.AddressesDetailAdapter;
import org.althash.wallet.ui.fragment.addresses_detail_fragment.AddressesDetailHolder;
...
class AddressesDetailAdapterLight<T extends TransactionInfo> extends AddressesDetailAdapter {
    ...
    public AddressesDetailHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(org.althash.wallet.R.layout.item_transaction_detail_light, parent, false);
