package org.althash.wallet.ui.fragment.receive_fragment;
...
import org.althash.wallet.ui.activity.main_activity.FragmentKeyboardEventListener;
...
import org.althash.wallet.ui.fragment.addresses_fragment.AddressesFragment;
...
public abstract class ReceiveFragment extends BaseFragment implements ReceiveView, FragmentKeyboardEventListener {
    ...
    private void chooseShareMethod() {
        if (getQrCode() != null) {
            String pathofBmp = MediaStore.Images.Media.insertImage(getContext().getContentResolver(), getQrCode(), "ALTHASH QRCode", "Share");
            ...
            getMainActivity().startActivity(Intent.createChooser(intentShareFile, "Althash QR-Code"));
        }
    }
