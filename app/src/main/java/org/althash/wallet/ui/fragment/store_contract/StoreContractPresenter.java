...
import org.althash.wallet.ui.fragment.send_fragment.SendInteractorImpl;
...
import static org.althash.wallet.datastorage.FileStorageManager.HUMANSTANDARDTOKENUUID;
        ...
        getUnspentOutputs(new SendInteractorImpl.GetUnspentListCallBack() {
            ...
            public void onSuccess(List<UnspentOutput> unspentOutputs) {
                ...
                try {
                    ...
                    callBack.onError(getView().getContext().getString(R.string.invalid_althash_address));
                    return;
                }
                //TODO STUB!
