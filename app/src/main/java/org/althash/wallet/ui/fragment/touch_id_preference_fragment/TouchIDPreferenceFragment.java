...
public abstract class TouchIDPreferenceFragment extends BaseFragment implements TouchIDPreferenceView {
    ...
    @OnClick({org.althash.wallet.R.id.bt_enable_touch_id, org.althash.wallet.R.id.bt_not_now})
    public void onClick(View view) {
        switch (view.getId()) {
            case org.althash.wallet.R.id.bt_enable_touch_id:
                getPresenter().onEnableTouchIdClick();
            case org.althash.wallet.R.id.bt_not_now:
                if (!mIsImporting) {
