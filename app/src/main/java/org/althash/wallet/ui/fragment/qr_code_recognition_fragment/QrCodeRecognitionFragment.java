package org.althash.wallet.ui.fragment.qr_code_recognition_fragment;
...
public class QrCodeRecognitionFragment extends Fragment implements ZXingScannerView.ResultHandler {
    ...
    @BindView(org.althash.wallet.R.id.camera_container)
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(org.althash.wallet.R.layout.fragment_qrcode_camera, container, false);
    }
    ...
    public void handleResult(Result result) {
        ...
        if (!TextUtils.isEmpty(receiveAddr)) {
            ...
            pattern = Pattern.compile("^$|^[H][a-km-zA-HJ-NP-Z1-9]{0,33}$");
            matcher = pattern.matcher(result.getText());
            if (matcher.matches()) {
