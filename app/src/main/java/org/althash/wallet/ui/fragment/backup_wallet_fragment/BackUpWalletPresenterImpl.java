...
import org.althash.wallet.ui.fragment.confirm_passphrase_fragment.ConfirmPassphraseFragment;
...
//                            AlthashSharedPreference.getInstance().setKeyGeneratedInstance(getView().getContext(), true);
