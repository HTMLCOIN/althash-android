...
import org.althash.wallet.model.gson.call_smart_contract_response.Item;
        ...
        getInteractor().unspentOutputsForAddressObservable(addressFrom)
                ...
                .subscribe(new Subscriber<SendRawTransactionResponse>() {
                    ...
                    public void onNext(SendRawTransactionResponse sendRawTransactionResponse) {
                        getView().setAlertDialog(org.althash.wallet.R.string.payment_completed_successfully, "Ok", BaseFragment.PopUpType.confirm);
                        getView().dismissProgressDialog();
                    }
                });
    }
