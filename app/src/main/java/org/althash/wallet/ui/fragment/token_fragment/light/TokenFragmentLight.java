package org.althash.wallet.ui.fragment.token_fragment.light;
...
import org.althash.wallet.ui.fragment.token_fragment.TokenFragment;
import org.althash.wallet.ui.fragment.token_fragment.dark.TokenHistoryAdapterDark;
...
public class TokenFragmentLight extends TokenFragment {
    ...
    private final int LAYOUT = org.althash.wallet.R.layout.lyt_token_fragment_light;

    @BindView(org.althash.wallet.R.id.wave_view)
    WaveView waveView;
    private WaveHelper mWaveHelper;

    @BindView(org.althash.wallet.R.id.bt_share)
    ImageButton mShareBtn;

    @BindView(org.althash.wallet.R.id.iv_choose_address)
    ImageView mIvChooseAddress;

    @BindView(org.althash.wallet.R.id.tv_token_name)
