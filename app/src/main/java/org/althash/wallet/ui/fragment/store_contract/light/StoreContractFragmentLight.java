package org.althash.wallet.ui.fragment.store_contract.light;
...
public class StoreContractFragmentLight extends StoreContractFragment {
    ...
    protected int getLayout() {
        return org.althash.wallet.R.layout.lyt_store_contract_light;
    }
    ...
    @OnClick(org.althash.wallet.R.id.ibt_view_abi)
    ...
    public void setContractData(QstoreContract contract) {
        ...
        rvTags.setAdapter(new TagRecyclerViewAdapter(contract.tags, this, org.althash.wallet.R.layout.item_tag_light));
