...
import org.althash.wallet.ui.fragment.wallet_fragment.HistoryCountChangeListener;
import org.althash.wallet.ui.fragment_factory.Factory;
import org.althash.wallet.ui.base.base_fragment.BaseFragment;
import org.althash.wallet.ui.fragment.token_fragment.dialogs.ShareDialogFragment;
import org.althash.wallet.utils.ClipboardUtils;
...
public abstract class TokenFragment extends BaseFragment implements TokenView, TokenHistoryClickListener {
    ...
    private static final String althashAddressKey = "althashAddressKey";
    ...
    @Override
    public void setAlthashAddress(String address) {
        if (!TextUtils.isEmpty(address)) {
