...
import org.althash.wallet.utils.EditTextValidated;
...
public abstract class InputViewHolder extends RecyclerView.ViewHolder implements EditTextValidated.EditTextValidateListener {
    ...
    @BindView(org.althash.wallet.R.id.til_param)
    protected
    TextInputLayout tilParam;

    @BindView(org.althash.wallet.R.id.et_param)
    protected
    EditTextValidated etParam;

    @BindView(org.althash.wallet.R.id.checkbox)
