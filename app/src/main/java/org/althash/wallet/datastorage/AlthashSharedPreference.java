package org.althash.wallet.datastorage;
...
import org.althash.wallet.utils.migration_manager.KeystoreMigrationResult;

import java.util.ArrayList;
import java.util.List;
import java.util.Locale;

public class AlthashSharedPreference {
    private static AlthashSharedPreference sInstance = null;

    private final String ALTHASH_DATA_STORAGE = "althash_data_storage";
    private final String ALTHASH_PASSWORD = "althash_wallet_password";
    private final String ALTHASH_SIX_DIGIT_PASSWORD = "althash_wallet_six_digit_password";
    private final String ALTHASH_IS_KEY_GENERATED = "althash_is_key_generated";
    private final String ALTHASH_SEED = "althash_seed";
    ...
    private AlthashSharedPreference() {

    }

    public static AlthashSharedPreference getInstance() {
        if (sInstance == null) {
            sInstance = new AlthashSharedPreference();
        }
        return sInstance;
    }

    public String getKeystoreMigrationState(Context context) {
        return context.getSharedPreferences(ALTHASH_DATA_STORAGE, Context.MODE_PRIVATE).getString(passphrase_migration_state
                , null);
    }

    public void setKeyStoreMigrationState(Context context, String state) {
        SharedPreferences mSharedPreferences = context.getSharedPreferences(ALTHASH_DATA_STORAGE, Context.MODE_PRIVATE);
    ...
    public boolean isTouchIdEnable(Context context) {
        return context.getSharedPreferences(ALTHASH_DATA_STORAGE, Context.MODE_PRIVATE).getBoolean(TOUCH_ID_ENABLE, false);
    }

    public void savePassword(Context context, String password) {
        SharedPreferences mSharedPreferences = context.getSharedPreferences(ALTHASH_DATA_STORAGE, Context.MODE_PRIVATE);
        SharedPreferences.Editor mEditor = mSharedPreferences.edit();
        mEditor.putString(ALTHASH_PASSWORD, password);
        mEditor.apply();
    }

    public String getPassword(Context context) {
        return context.getSharedPreferences(ALTHASH_DATA_STORAGE, Context.MODE_PRIVATE).getString(ALTHASH_PASSWORD, "");
    }
    ...
    public String getCurrentAddress(Context context) {
        return context.getSharedPreferences(ALTHASH_DATA_STORAGE, Context.MODE_PRIVATE).getString(CURRENT_ADDRESS, null);
    }
    ...
    public Long getBanTime(Context context) {
        return context.getSharedPreferences(ALTHASH_DATA_STORAGE, Context.MODE_PRIVATE).getLong(BAN_TIME, 0);
    }
    ...
    public Integer getFailedAttemptsCount(Context context) {
        return context.getSharedPreferences(ALTHASH_DATA_STORAGE, Context.MODE_PRIVATE).getInt(FAILED_ATTEMPTS_COUNT, 0);
    }

    public void saveSixDigitPassword(Context context, String password) {
        SharedPreferences mSharedPreferences = context.getSharedPreferences(ALTHASH_DATA_STORAGE, Context.MODE_PRIVATE);
        SharedPreferences.Editor mEditor = mSharedPreferences.edit();
        mEditor.putString(ALTHASH_SIX_DIGIT_PASSWORD, password);
        mEditor.apply();
    }

    public String getSixDigitPassword(Context context) {
        return context.getSharedPreferences(ALTHASH_DATA_STORAGE, Context.MODE_PRIVATE).getString(ALTHASH_SIX_DIGIT_PASSWORD, "");
    }
    ...
    public String getTouchIdPassword(Context context) {
        return context.getSharedPreferences(ALTHASH_DATA_STORAGE, Context.MODE_PRIVATE).getString(TOUCH_ID_PASSWORD, "");
    }

    public void setKeyGeneratedInstance(Context context, boolean isKeyGenerated) {
        SharedPreferences mSharedPreferences = context.getSharedPreferences(ALTHASH_DATA_STORAGE, Context.MODE_PRIVATE);
        SharedPreferences.Editor mEditor = mSharedPreferences.edit();
        mEditor.putBoolean(ALTHASH_IS_KEY_GENERATED, isKeyGenerated);
        mEditor.apply();
    }

    public boolean getKeyGeneratedInstance(Context context) {
        return context.getSharedPreferences(ALTHASH_DATA_STORAGE, Context.MODE_PRIVATE).getBoolean(ALTHASH_IS_KEY_GENERATED, false);
    }



    public String getSeed(Context context) {
        return context.getSharedPreferences(ALTHASH_DATA_STORAGE, Context.MODE_PRIVATE).getString(ALTHASH_SEED, "");
    }

    public void saveSeed(Context context, String seed) {
        SharedPreferences mSharedPreferences = context.getSharedPreferences(ALTHASH_DATA_STORAGE, Context.MODE_PRIVATE);
        SharedPreferences.Editor mEditor = mSharedPreferences.edit();
        mEditor.putString(ALTHASH_SEED, seed);
        mEditor.apply();
    }
    ...
    public Integer getMinGasPrice(Context context) {
        return context.getSharedPreferences(ALTHASH_DATA_STORAGE, Context.MODE_PRIVATE).getInt(MIN_GAS_PRICE, 40);
    }
    ...
    public String getBalanceString(Context context){
        return context.getSharedPreferences(ALTHASH_DATA_STORAGE, Context.MODE_PRIVATE).getString(BALANCE_STRING,"0");
    }
    ...
    public String getUnconfirmedBalanceString(Context context){
        return context.getSharedPreferences(ALTHASH_DATA_STORAGE, Context.MODE_PRIVATE).getString(UNCONFIRMED_BALANCE_STRING,"0");
    }
    ...
    public Long getLastUpdatedBalanceTime(Context context) {
        return context.getSharedPreferences(ALTHASH_DATA_STORAGE, Context.MODE_PRIVATE).getLong(LAST_UPDATED_BALANCE_TIME, 0);
    }
